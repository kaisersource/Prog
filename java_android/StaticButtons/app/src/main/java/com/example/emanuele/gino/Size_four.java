...
public class Size_four extends AppCompatActivity {

    public EditText e00, e01, e10, e11, e02, e20, e12, e21, e22,e03,e13,e23,e30,e31,e32,e33;
    private TextView r_zero, r_one, r_two,r_three, c_zero, c_one, c_two,c_three, edges, mostedgedval, graphconn, graphreg;
    private int dim, A[][];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e30 = (EditText) findViewById(R.id.e30);
        ...
        verifica.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                try {
                    ...
                    A[0][3] = Integer.parseInt(e03.getText().toString());
                    ...
                    A[1][3] = Integer.parseInt(e13.getText().toString());
                    ...
                    A[2][3] = Integer.parseInt(e23.getText().toString());
                    A[3][0] = Integer.parseInt(e30.getText().toString());
                    A[3][1] = Integer.parseInt(e31.getText().toString());
                    A[3][2] = Integer.parseInt(e32.getText().toString());
                    A[3][3] = Integer.parseInt(e33.getText().toString());

                } catch (Exception e) {
                    Message.alert_msg(Size_four.this, "Attenzione", "Numero non consentito");
                }
