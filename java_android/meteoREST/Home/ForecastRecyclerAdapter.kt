    ...
    * */
    ...
    inner class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        fun bindData(position: Int) {
            ...
            val high = forecast?.high?.toInt() ?: 0 //le massime
            val low = forecast?.low?.toInt() ?: 0 //le minime
            ...
            //aggiorno l'immagine in base al codice nella classe WeatherToI nella classe utils
